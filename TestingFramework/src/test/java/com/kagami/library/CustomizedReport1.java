...
public class CustomizedReport1 implements IReporter{
	...
	private void startResultSummaryTable(String style) {
		...
		writer.println("<br><font color='#474352'><h2 align='left'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Test Execution Details</h2></font><br>");
	...
	private void resultDetail(IResultMap tests) {
		...
		for (ITestResult result : testResultsList) {
			...
			writer.println("<h2 id='m_methodIndex'>" + cname  + method.getMethodName() + "</h2>");
			Set<ITestResult> resultSet = tests.getResults(method);
