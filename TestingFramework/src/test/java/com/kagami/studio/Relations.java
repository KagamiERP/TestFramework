...
public class Relations {
	...
	public void relationManager(ExtentTest test)
	{
		try{
			...
			genericMethods.waitForElementVisibility(driver, By.xpath("//h3[text()='TotalOverdose']"), 30);
			genericMethods.clickElementByJsExecutor(driver, By.xpath("//h3[text()='TotalOverdose']"), test);
			...
			Thread.sleep(1000);
			//	WebElement dragFrom = driver.findElement(By.xpath("//p[@id='parentid']"));
			WebElement dragFrom = driver.findElement(By.xpath("//span[contains(text(),'NameOverdose')]"));
			WebElement dragTo = driver.findElement(By.xpath("//*[@id='SvgjsSvg1001']"));
			Actions act = new Actions(driver);
			if(dragFrom.isDisplayed() && dragTo.isDisplayed()){
