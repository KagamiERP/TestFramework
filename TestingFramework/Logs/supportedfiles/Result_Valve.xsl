			...
			<td>
				...
				<table style = "border:1px solid black;" border = "1" cellpadding = "5" align="center" class="summary">
					<tr  bgcolor="#9acd32" style="height:40px">
						<th>Valve Indication Name</th>
						<th>Total TC count</th>		
						<th>Executed TC count</th>
						<th>Pass TC count</th>
						<th>Fail TC count</th>
					</tr>
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAorticStenosis")]) >0'>
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>Aortic Stenosis</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='115'/></a></output></td>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAorticRegurgitation")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMitralStenosis")]) >0'>	
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>Mitral Stenosis</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='37'/></a></output></td>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMitralRegurgitation")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveTricuspidStenosis")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveTricuspidRegurgitation")]) >0'>	
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>Tricuspid Regurgitation</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='34'/></a></output></td>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAR+TS")]) >0'>	
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>AR with TS</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='9'/></a></output></td>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAR+TR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMS+MR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMS+TS")]) >0'>	
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>MS with TS</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='17'/></a></output></td>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveTS+TR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMS+AR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAS+AR")]) >0'>	
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>AS with AR</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='100'/></a></output></td>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAS+MS")]) >0'>	
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>AS with MS</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='51'/></a></output></td>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAS+MR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAS+TS")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveAS+TR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMR+AR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMS+TR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMR+TS")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveMR+TR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveCAD+AS")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveCAD+AR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveCAD+MS")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveCAD+MR")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveCAD+TS")]) >0'>	
					<tr>
					...
					<xsl:if test='count(//TestSuite/Functionality[@name="ValvewithorwithoutCABG"]//TestScript[contains(@name,"ValveCAD+TR")]) >0'>	
					<tr>
					...
					<tr>
						...
						<td align="center"><output><a href="#" onClick="TotalExecuted();"><xsl:value-of select='$Aortic_Stenosis+$Aortic_Regurgitation+$Mitral_Stenosis+$Mitral_Regurgitation+$Tricuspid_Stenosis+$Tricuspid_Regurgitation+$ARwithTS+$ARwithTR+$MSwithMR+$MSwithTS+$TSwithTR+$ARwithMS+$ASwithAR+$ASwithMS+$ASwithMR+$ASwithTS+$ASwithTR+$ARwithMR+$MSwithTR+$MRwithTS+$MRwithTR+$CADwithAS+$CADwithAR+$CADwithMS+$CADwithMR+$CADwithTS+$CADwithTR'/></a></output></td>
