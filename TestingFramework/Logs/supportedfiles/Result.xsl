 ...
 .Tstamp
 {
  ...
  <br></br>
	...
	<table align="center">
		<tr>
		<td>
			<h3 style="background:#808080;color:#FFFFFF;margin-left:37%;margin-right:35%;padding-left:25px;padding-right: 25px;float: center;"><font face="Calibri" size="4">Build Details</font></h3>
			<table border="1" align="center" cellpadding="5" >
					<tr>
					     <th align="center"><font face="Calibri" size="2" color="#000000"><b>Build</b></font></th>
					     <th align="center"><font face="Calibri" size="2" color="#000000"><b>Browser</b></font></th>
					     <th align="center"><font face="Calibri" size="2" color="#000000"><b>Server</b></font></th>
				    </tr>
				    <tr>
			...
			<tr><td>
				<h3 style="" ><a href="#" onClick="Home();" style="padding-left:20%;padding-right:25%;background:#808080;color:#FFFFFF;margin-left:10%;float: center;"><font face="Calibri" size="4">Home</font></a></h3>
				<table style = "border:1px solid black;" border = "1" cellpadding = "5" align="center" class="summary">
					<tr  bgcolor="#9acd32" style="height:40px">
						...
						<th>Total Executed Count</th>		
						<th>Pass Count</th>
						<th>Fail Count</th>
					</tr>	
					<xsl:if test='count(//TestSuite/Functionality[@name="LumbarProcedure"]/TestScript) >0'>			
						<tr>
							<td align="center"><font face="Calibri" size="2" color="#000000"><b>LumbarProcedure</b></font></td>
							<td align="center"><output><a  onClick="Total();"><xsl:value-of select='63'/></a></output></td>
					...
					<tr>
                        ...
                        <td align="center"><font face="Calibri" size="2" color="#000000"><b>IncisionalHernia</b></font></td>
                        <td align="center"><output><a  onClick="Total();"><xsl:value-of select='70'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>THA</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='46'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>TKA</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='42'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>WLS</b></font></td>
						<td align="center"><output><a href="#" onClick="Total();"><xsl:value-of select='11'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>CarotidStenosis</b></font></td>
						
						<td align="center"><output><a onClick="Total();"><xsl:value-of select='20'/></a></output></td>
						<td align="center"><output><a  onClick="CarotidStenosis();"><xsl:value-of select='count(//TestSuite/Functionality[@name="CarotidStenosis"]/TestScript)'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>ProstateBiopsy</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='65'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>VenaCava</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='30'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>ICD_Secondary</b></font></td>
						<td align="center"><output><a onClick="Total();"><xsl:value-of select='257'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>ICD_Primary</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='557'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>ICD_CRT</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='227'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>DiagCath</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='127'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>Mohs</b></font></td>
						<td align="center"><output><a onClick="Total();"><xsl:value-of select='95'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>Cervical</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='21'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>PM</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='16'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>PAD</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='13'/></a></output></td>
					...
					<tr>
						<td align="center"><font face="Calibri" size="2" color="#000000"><b>Hysterectomy</b></font></td>
						<td align="center"><output><a  onClick="Total();"><xsl:value-of select='15'/></a></output></td>
					...
					<tr style="background-color:#9acd32;color:#9acd32;">
						<td align="center"><font face="Calibri" size="2" color="#FFFFFF"><b>TOTAL</b></font></td>
						<td align="center"><a onClick="Total();"><output><xsl:value-of select= '$Lumbar+$Hernia+$THA+$CarotidStenosis+$ProstateBiopsy+$VenaCava+$DiagCath+$TKA+$ICD_Secondary+$ICD_Primary+$ICD_CRT+$WLS+$Mohs+$Cervical+$PM+$PAD+$Hysterectomy'/></output></a></td>
						<td align="center"><a href="#" onClick="TotalExecuted();"><output><xsl:value-of select= '$Lumbar+$Hernia+$THA+$CarotidStenosis+$ProstateBiopsy+$VenaCava+$DiagCath+$TKA+$ICD_Secondary+$ICD_Primary+$ICD_CRT+$WLS+$Mohs+$Cervical+$PM+$PAD+$Hysterectomy'/></output></a></td>
						<td align="center"><a href="#" onClick="TotalPass();"><output><xsl:value-of select='$Lumbarpass+$Herniapass+$THApass+$CarotidStenosispass+$ProstateBiopsypass+$VenaCavapass+$DiagCathpass+$TKApass+$WLSpass+$ICD_SecondaryPass+$ICD_PrimaryPass+$ICD_CRTPass+$MohsPass+$CervicalPass+$PMPass+$PADPass+$HysterectomyPass'/></output></a></td>
						<td align="center"><a href="#" onClick="TotalFail();"><output><xsl:value-of select='$Lumbarfail+$Herniafail+$THAfail+$CarotidStenosisfail+$ProstateBiopsyfail+$VenaCavafail+$DiagCathfail+$TKAfail+$WLSfail+$ICD_Secondaryfail+$ICD_Primaryfail+$ICD_CRTfail+$Mohsfail+$Cervicalfail+$PMfail+$PADfail+$Hysterectomyfail'/></output></a></td>
					</tr>
...
<div id="TotalWLS" style="display:none;">
	...
	<table  border="1" align="center" class="maintable">
		...
		<xsl:for-each select='TestSuite/Functionality[@name="WLS"]'>
		<xsl:variable name="functionalityName"><xsl:value-of select="@name"/></xsl:variable>
		<xsl:variable name="num7"><xsl:value-of select="position()"/></xsl:variable>
			<xsl:for-each select="TestScript">
				<xsl:variable name="num2"><xsl:value-of select="$num7" /><xsl:value-of select="position()" /></xsl:variable>
...
<div id="TKAFAIL" style="display:none;">
	<h3 style="background:#808080;color:#FFFFFF;margin-left:12%;margin-right:12%;text-align:center"><font face="Calibri" size="4">TKA Fail Test Results</font></h3>
	<table  border="1" align="center" class="maintable">
		<tr bgcolor="#9acd32" style="height:40px">
			<th align="center" width="100px"><b>Functionality</b></th>
			<th align="center"><b>TestScript</b></th>
...
<div id="ICD_CRTFAIL"  style="display:none;">
	<h3 style="background:#808080;color:#FFFFFF;margin-left:12%;margin-right:12%;text-align:center"><font face="Calibri" size="4">ICD_CRT Fail Test Results</font></h3>
	<table  border="1" align="center" class="maintable">
		<tr bgcolor="#9acd32" style="height:40px">
			<th align="center" width="100px"><b>Functionality</b></th>
			<th align="center"><b>TestScript</b></th>
				...
				<xsl:variable name="num2"><xsl:value-of select="$num39" /><xsl:value-of select="position()" /></xsl:variable>
					...
					<tr style="display:none;"><xsl:attribute name="class">panel37<xsl:value-of select="$num2"/></xsl:attribute>
						...
						<xsl:for-each select="Iterator">
							...
							<table border=".5" align="center" class="test">
								<tr>
									<td align="center" colspan="5" class="flip38" ><xsl:attribute name="id"><xsl:value-of select="$num40"/></xsl:attribute><font face="Calibri" size="2" color="#000000"><b>Iteration : <xsl:value-of select="@no"/></b></font></td>
								</tr>
							</table>
							<tr style="display:none;"><xsl:attribute name="class">panel38<xsl:value-of select="$num40"/></xsl:attribute>
								<td colspan="5">
								<div style="display:none;"><xsl:attribute name="id">panel38<xsl:value-of select="$num40"/></xsl:attribute>
								<table border="1" align="center" class="test1" >
									<tr bgcolor="#DCDCDC">
										<th><font face="Calibri" size="2" color="#000000">Step No</font></th>
										<th><font face="Calibri" size="2" color="#000000">Step Name</font></th>
